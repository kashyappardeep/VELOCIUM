                              ...
                              <table  class="table table-striped table-bordered dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="tbldata_info">
                                 ...
                                 <tbody>
                                   ...
                                   <tr class="odd">
                                       ...
                                       <td style="width: 99.8542px; padding-top: 0px; padding-bottom: 0px; border-top-width: 0px; border-bottom-width: 0px; height: 0px;" data-column-index="2" class="sorting_disabled" rowspan="1" colspan="1" aria-label="Amount">{{$histroy->amount}}</td>
                                       @IF($histroy->status == 0)
                                       ...
                                       <td style="color : rgb(27, 232, 27)"  data-column-index="3" class="sorting_disabled" rowspan="1" colspan="1" style="width: 181.604px; padding-top: 0px; padding-bottom: 0px; border-top-width: 0px; border-bottom-width: 0px; height: 0px;" aria-label="Status">Complete</td> 
                                      @else
                                       <td style="color : rgb(247, 19, 19)"  data-column-index="3" class="sorting_disabled" rowspan="1" colspan="1" style="width: 181.604px; padding-top: 0px; padding-bottom: 0px; border-top-width: 0px; border-bottom-width: 0px; height: 0px;" aria-label="Status">Reject</td> 
                                       @endif
                                    </tr>
                                    @endforeach
                                    @else
