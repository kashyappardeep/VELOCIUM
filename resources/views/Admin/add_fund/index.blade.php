       ...
       <div class="col-md-12">
          <div class="card ">
             <div class="card-header ">
                <h5 class="card-title" id="pagetitle">Add Fund Request</h5>
             </div>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td class="sorting_disabled" style="width: 276.604px;" aria-label="Status">
                                            ...
                                            <form action="{{ route('accept_request', $add_fund_req->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                             ...
                                             <form action="{{ route('reject_request',$add_fund_req->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('PUT')
